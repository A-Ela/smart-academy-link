...
@section('content')
    <div class="container mt-4">
        ...
        <div style="display: flex; justify-content: s@extends('layouts.app')
    ...
    <div class="container mt-4">
        ...
        <form action="{{ url('/homework') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="subject_name" class="form-control" id="subject_name" required>
                    ...
                    <option value="Tulisan Jawi">Tulisan Jawi</option>
                    <option value="Cukup Solat">Cukup Solat</option>
                    <option value="Amali Solat">Amali Solat</option>
                    <option value="Tilawah Al Quran">Tilawah Al Quran</option>
                    <option value="Mathurat">Mathurat</option>
                </select>
            </div>
...
@endsectionpace-between; align-items: center; margin-bottom: 20px; width: 100%;">
            <h2 style="margin-right: auto;">Assign Homework</h2>
            <a href="{{ route('homework.list') }}" class="btn btn-view">
                <i class="fas fa-eye"></i> View Homework List
            </a>
