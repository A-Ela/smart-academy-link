...
@section('content')
<div class="container">
    <h1>Import Teacher Data</h1>
    <p>Please upload your Excel file to import Teacher data.</p>
    
    <!-- Form for importing an Excel file -->
    <form action="{{ route('teacher-list.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <!-- Submit Button -->
        <div>
            <button type="submit">Import Teacher</button>
        </div>
    </form>
