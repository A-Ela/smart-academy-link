...
@section('content')
<div class="container">
    <h1>Import Class Data</h1>
    <p>Please upload your Excel file to import Class data.</p>
    
    <!-- Form for importing an Excel file -->
    <form action="{{ route('class-list.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <!-- Submit Button -->
        <div>
            <button type="submit">Import Class</button>
        </div>
    </form>
