...
<div class="container">
    ...
    <p>Please upload your Excel file to import Student data.</p>
    
    <!-- Form for importing an Excel file -->
    <form action="{{ route('student-list.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <!-- Submit Button -->
        <div>
            <button type="submit">Import Student</button>
        </div>
    </form>
